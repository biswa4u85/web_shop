...
export class BrandDto extends BrandsEntity { };

export class CreateBrandDto extends OmitType(BrandDto, ['id']) { };
export class UpdateBrandDto extends OmitType(BrandDto, ['id']) { };
export class QueryBrandDto extends QuerysEntity { };
