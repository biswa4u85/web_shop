...
export class PurchaseDto extends PurchasesEntity { };

export class CreatePurchaseDto extends OmitType(PurchaseDto, ['id']) { };
export class UpdatePurchaseDto extends OmitType(PurchaseDto, ['id']) { };
export class QueryPurchaseDto extends QuerysEntity { };

export class GetPurchasesDto {
    @ApiProperty({ required: true })
    count: number;

    @ApiProperty({ type: PurchaseDto, isArray: true })
    data: PurchaseDto[];
};