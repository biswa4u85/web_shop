...
export class CategoryDto extends CategoriesEntity { };

export class createCategoryDto extends OmitType(CategoryDto, ['id']) { };
export class UpdateCategoryDto extends OmitType(CategoryDto, ['id']) { };
export class QueryCategoryDto extends QuerysEntity { };
