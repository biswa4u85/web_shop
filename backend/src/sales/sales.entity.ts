...
export class SaleDto extends BrandsEntity { };

export class CreateSaleDto extends OmitType(SaleDto, ['id']) { };
export class UpdateSaleDto extends OmitType(SaleDto, ['id']) { };
export class QuerySaleDto extends QuerysEntity { };
