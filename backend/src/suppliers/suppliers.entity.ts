...
export default class SuppliersEntity {
...
export class SupplierDto extends SuppliersEntity { };

export class CreateSupplierDto extends OmitType(SupplierDto, ['id']) { };
export class UpdateSupplierDto extends OmitType(SupplierDto, ['id']) { };
export class QuerySupplierDto extends QuerysEntity { };
