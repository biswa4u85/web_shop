...
export default class StoresEntity {
...
export class StoreDto extends StoresEntity { };

export class CreateStoreDto extends OmitType(StoreDto, ['id']) { };
export class UpdateStoreDto extends OmitType(StoreDto, ['id']) { };
export class QueryStoreDto extends QuerysEntity { };

export class GetStoresDto {
    @ApiProperty({ required: true })
    count: number;

    @ApiProperty({ type: StoreDto, isArray: true })
    data: StoreDto[];
};